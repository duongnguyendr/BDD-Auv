...
public class InviteNewClientStepDefinition extends BaseInit {
    private static Logger logger = Logger.getLogger(InviteNewClientStepDefinition.class.getSimpleName());
    BaseInit baseInit;
    ...
    public void iSeeInviteNewClientPopUp(){
        logger.info("I should see invite new client popup");
    ...
    public void iSelectAddNewClientOnNewClientPopup() throws Throwable {
        ...
        logger.info("I select add new client on new client popup");
    ...
    public void iClickOnInviteButtonOnInviteClientPopup() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        logger.info("I click on invite button on invite client popup");
    ...
    public void iShouldSeeMessageInviteSuccessful(String msg) throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        logger.info("I should see message invite successful");
