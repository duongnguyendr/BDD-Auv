package com.auvenir.ui.bdd.common.reportLB;
...
public class GeneratePDF {
    ...
    private static void createDetailTable(Paragraph preface,ReportResult reportResult) throws DocumentException, IOException {
        ...
        float[] columnWidths = new float[10];
    ...
    private static void addTitlePageCucumberPDF(Document document, String timeStamp, ReportResult reportResult) throws DocumentException, IOException {
        ...
        table.addCell(createImageCellCucumberPDF(System.getProperty("user.dir") + "\\Reports\\ImageReports\\" + timeStamp +"\\FeaturesChart" +  "_" + timeStamp + ".png"));
        table.addCell(createImageCellCucumberPDF(System.getProperty("user.dir") + "\\Reports\\ImageReports\\" + timeStamp +"\\ScenariosChart" +  "_" + timeStamp + ".png"));
        document.add(table);
